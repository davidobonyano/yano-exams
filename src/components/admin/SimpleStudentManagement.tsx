...
export default function SimpleStudentManagement({ teacherId, onClose }: SimpleStudentManagementProps) {
  ...
  const [nextStudentNumber, setNextStudentNumber] = useState<number>(1)
  ...
  const handleBulkImport = async () => {
    ...
    for (const line of lines) {
      ...
      const [name, classLevel, schoolName, email = '', phone = '', parentName = '', parentPhone = ''] = parts
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-6xl w-full max-h-[90vh] overflow-hidden">
        <div className="p-6 border-b border-gray-200">
          ...
          <p className="text-gray-600 mt-2">
            Manage students with YAN/number format (e.g., YAN001, YAN002) - Next ID: YAN{String(nextStudentNumber).padStart(3, '0')}
          </p>
        </div>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-60">
            <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full p-6">
              ...
              <p className="text-sm text-gray-600 mb-4">
                Format: Name, Class, School, Email, Phone, Parent Name, Parent Phone
              </p>
              <textarea
                value={bulkText}
                onChange={(e) => setBulkText(e.target.value)}
                placeholder="Alice Johnson, JSS1, Demo School, alice@demo.com, 08012345678, Mr. Johnson, 08087654321&#10;Bob Smith, SS1, Demo School, bob@demo.com, 08023456789, Mrs. Smith, 08076543210"
