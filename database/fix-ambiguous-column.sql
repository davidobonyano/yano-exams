-- Fix the ambiguous column reference in join_session_by_student_id function
...
BEGIN
  ...
  -- Find the student by student_id in teacher_students table
...
SELECT 'Fixed ambiguous column reference in join_session_by_student_id function!' as status;